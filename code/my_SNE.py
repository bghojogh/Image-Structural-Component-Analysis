...
class My_SNE:
    ...
    def __init__(self, X, n_components=None, kernel=None):
    ...
    def t_SNE_embed(self, max_iterations=1000, step_checkpoint=20, calculate_again=True):
    ...
    def SNE_embed(self, max_iterations=1000, step_checkpoint=20, calculate_again=True):
        if calculate_again == False:
            path_to_save = './output/SNE/'
            Y = self.load_variable(name_of_variable="Y_", path=path_to_save + 'Y/')
            return Y
